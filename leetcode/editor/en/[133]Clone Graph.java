...
//node. 
// 
// Related Topics Hash Table Depth-First Search Breadth-First Search Graph 👍 37
//92 👎 1903
...
//        System.out.println("node.val = " + node.val);
        ...
        memo.put(node, retNode);

        for (Node neighbor : node.neighbors) {
            Node tNode = recur(neighbor);
            if (tNode != null) {
                retNode.neighbors.add(tNode);
            }
        }
        return retNode;
    }
